...
export function ZahnarztFinalCtaSection() {
  return (
    <section className="relative py-20 sm:py-28">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-xl border border-primary/40 bg-gradient-to-b from-primary/[0.1] to-card p-8 text-center shadow-glow sm:p-14">
          ...
          >
            Bereit für mehr Neupatienten &amp; Anfragen in Ihrer
            Zahnarztpraxis?
          </h2>
          <p className="relative mx-auto mt-4 max-w-xl text-pretty leading-relaxed text-muted-foreground">
            Lassen Sie Ihre aktuelle Praxis-Website jetzt kostenlos von
            uns auf Ladezeit, mobile Darstellung und lokales
            Google-Potenzial für Ihr Stadtname / Ihre Region prüfen.
          </p>
