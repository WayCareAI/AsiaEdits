...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildIndustryMetadata(industry, 'webdesign')
}

export default async function BranchenWebdesignIndustryPage({ params }: PageProps) {
  const { industry } = await params
  return <IndustryLandingPage industrySlug={industry} keywordType="webdesign" />
}
